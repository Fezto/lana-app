...
export const generateRecurringTransactions = (
    params: GenerateRecurringTransactionsParams,
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
) => {
      
      
      return customInstance<TransactionRead[]>(
      {url: `/transactions/generate-recurring`, method: 'POST',
        params, signal
    },
      options);
    }
...
export const getGenerateRecurringTransactionsMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateRecurringTransactions>>, TError,{params: GenerateRecurringTransactionsParams}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof generateRecurringTransactions>>, TError,{params: GenerateRecurringTransactionsParams}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof generateRecurringTransactions>>, {params: GenerateRecurringTransactionsParams}> = (props) => {
          const {params} = props ?? {};

          return  generateRecurringTransactions(params,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateRecurringTransactionsMutationError = HTTPValidationError

    /**
 * @summary Generate Recurring Transactions
 */
export const useGenerateRecurringTransactions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateRecurringTransactions>>, TError,{params: GenerateRecurringTransactionsParams}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient): UseMutationResult<
